...
class FundSubscriptionServiceImplTest {
    ...
    void setUp() {
        ...
        testClient.setBalance(BigDecimal.valueOf(1000L));
        ...
        testFund = new Fund("1", "Test Fund", BigDecimal.valueOf(500L), "Categoria");
    ...
    void subscribe_debitsClientSavesSubscriptionRegistersTransactionAndNotifies() {
        ...
        assertEquals(BigDecimal.valueOf(500L), testClient.getBalance());
        verify(subscriptionRepository).save(any(Subscription.class));
        verify(transactionService).register("1", "1", TransactionType.OPENING, BigDecimal.valueOf(500L));
    ...
    void subscribe_rejectsWhenInsufficientBalance() {
        testClient.setBalance(BigDecimal.valueOf(400L));
